    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        ...
        <!-- Begin 3rd Row -->
          ...
          <h2>EXPERIENCE</h2>
          <div class="content">
            <h3><?php echo $l[21]?> / <?php echo $l[22]?></h3>
            <p><?php echo $l[18]?><br /><?php echo $l[19]?>
              <em><?php echo $l[20]?></em></p>
          </div></div>
                <div class="entry">
          <h2>Stage</h2>
          <div class="content">
            <h3><?php echo $l[26]?> / <?php echo $l[27]?></h3>
            <p><?php echo $l[23]?><br /><?php echo $l[24]?>
              <em><?php echo $l[25]?></em></p>
          </div></div>
