  ...
  <section id="section-1">
      ...
      <div class="menufix"> <a class="logo" href="index.html"><img src="images/iway.png" alt="Hello"></a>
        ...
        <nav>
          <ul>
             ...
             <li ><a class="out active animsition-link" href="blogAdmin.php">EQUIPE</a></li>
    ...
    <div class="grid flex">
      <div class="row">
        ...
        <div class="bannerbox">
          <div class="banner">
            <div class="phrase-1">Ajouter des Employés</div>
            <div class="phrase-2"><a href="ajoutEmploye.html"  > Ajouter </a></div>
...
?>
        <div class="col_4 beta">
          ...
          <div class="boxwsha column3">
            ...
            <div class="clear"></div>
            <div class="fix-btn-blog"> <a href="modifEmp.php?cin=<?php echo"$l[0]";?>" class="istria-btn">Modifier</a>
            ...
            <!-- END fix-btn -->  <div class="clear"></div>
            <div class="fix-btn-blog"> <a href="../Controlleurs/supEmp.php?cin=<?php echo"$l[0]";?>" class="istria-btn">Supprimer</a>
              <div class="istria-over"></div>
              <div class="istria-line left">
                <div class="inner"></div>
              </div>
