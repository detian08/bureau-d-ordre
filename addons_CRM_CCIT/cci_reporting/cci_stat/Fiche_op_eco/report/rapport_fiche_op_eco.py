...
class jasper_client(JasperDataParser.JasperDataParser):
	...
	def generate_records(self, cr, uid, ids, data, context):
		...
		if 'form' in data:
			...
			result.append(data)
			#cr.execute("SELECT * FROM cmr_lead WHERE stage_id =%s",(6,))
			#ops_objs = cr.dictfetchall()
			#print 'op',ops_objs
			if ops_objs:
				for op in ops_objs:
					print 'op.date_debut ......',op.date_debut
			...
			if lines :
				...
				if dict_section:
					section_id=dict_section[0]['crm_case_section_id']
