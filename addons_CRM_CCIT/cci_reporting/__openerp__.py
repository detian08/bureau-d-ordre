...
CCI offre la possiblite d'imprimer des rapports spécifiques et de consulter les statistiques concernant les opportunités, les activités, les produits et ses revenus sous forme de tableau de bord """,
	...
	"author" : "Marwa BEN MESSAOUD et YAAKOUBI Ghaida I-WAY",
    ...
    "update_xml" :[
		...
		#'cci_kanban/crm_dash_activity_test.xml',
        	'cci_kanban/crm_dashboard_after.xml',
			...
			'cci_stat/OE_mining/wizard/next_wizard_survey.xml',
			'cci_stat/OE_mining/wizard/next_wizard_consultation.xml',
			'cci_stat/OE_mining/wizard/wizard_opportunite.xml'
