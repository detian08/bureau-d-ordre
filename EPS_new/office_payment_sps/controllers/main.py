...
class spsController(http.Controller):
    _notify_url = '/paiement/sps/ipn/'
    _return_url = '/paiement/sps/dpn/'
    _cancel_url = '/paiement/sps/cancel/'
    ...
    @http.route('/paiement/sps/ipn/', type='http', auth='none', methods=['POST'])
    ...
    @http.route('/paiement/sps/dpn', type='http', auth="none", methods=['POST'])
    ...
    @http.route('/paiement/sps/cancel', type='http', auth="none")
