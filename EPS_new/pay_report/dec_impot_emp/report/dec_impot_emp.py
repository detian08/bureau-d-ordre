            ...
            if employee_objs:
                for employee in employee_objs:
                    ...
                    if employee.marital=='single' :
                        ...
                        marital=' '
                    if employee.address_home_id.street and employee.address_home_id.street2 and employee.address_home_id.city:
                        adresse=employee.address_home_id.street+" "+employee.address_home_id.street2+" "+employee.address_home_id.city
                    else :
                        adresse= " "
                    imposable=0
                    irpp=0
